...
def on_progress(stream, chunk, bytes_remaining):
    try:
        ...
        # naive update of all entries in progress_map
...
def start_download():
    ...
    try:
        ...
        if format_type == 'audio':
            ...
            return jsonify({"download_id": os.path.basename(mp3_path)}), 200
            ...
            return jsonify({"download_id": os.path.basename(file_path)}), 200
...
def get_progress(download_id):
    file_id = download_id.rsplit('.', 1)[0]  # strip .mp3/.mp4
